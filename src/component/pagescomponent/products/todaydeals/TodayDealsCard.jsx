...
const TodayDealsCard = ({ todayproducts, addToCart }) => {
  return (
    <div>
      <div className="card mb-2 col-md-10 col-sm-10 col-lg-10 col-xl-11 col-xxl-11 m-3 ">
        <div className="card-header p-0 position-relative mt-n3 mx-0  z-index-3">
          <a className="d-block blur-shadow-image ">
            <img src={todayproducts.image}
        ...
        <div className="card-body text-start">
          ...
          <h5 className="font-weight-bold mt-3 text-gradient text-primary">
            <a href="javascript:;">{todayproducts.title}</a>
          </h5>
          <p className="mb-0">
            {todayproducts.title1}
          </p>
        </div>
        <div className="card-footer d-flex pt-0 pb-0">
          <h5 className="font-weight-bold my-auto">₹{todayproducts.price}</h5>
          <p className="font-weight-bold text-danger  m-1"><s>₹{todayproducts.oldprice}</s></p>
        ...
        <div className="row mt-2 mb-3">
          <div className="col-lg-6 mx-auto">
            <button className="btn bg-gradient-primary mb-0 mt-lg-auto w-100 p-2" type="button"
              name="button" onClick={() => addToCart(todayproducts)} >Add to cart</button>
          </div>
          <div className="col-lg-6 mx-auto ">
